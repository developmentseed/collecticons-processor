...
describe('Font generator', function () {
  it('Throw error when called without fontName', async function () {
    try {
      await generateFonts();
    } catch (error) {
  ...
  it('Throw error when called without icons', async function () {
    try {
  ...
  it('Throw error when called with non array icons', async function () {
    try {
  ...
  it('Throw error when called with empty icons', async function () {
    try {
  ...
  it('Return an object with all the generated fonts', async function () {
    const icons = [
      {
